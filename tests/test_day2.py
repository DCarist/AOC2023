...
def test_create_dataclass():
    test_dice = day_2.create_diceroll('4 red')
    assert day_2.DiceRoll(4, 'red') == test_dice

def test_create_round():
    red_dice = day_2.DiceRoll(6,'red')
    green_dice = day_2.DiceRoll(7,'green')
    blue_dice = day_2.DiceRoll(8, 'blue')
